function paradigm_overShootVarDelay(handles)
...
% This delay is additional to the standard (fixed) delay preceeding each
%  stimulus. 
% The delay is a random duration between 0 and stimulusDelayVariability

stimulusParameters.stimulusDelayVariability=0.5;
