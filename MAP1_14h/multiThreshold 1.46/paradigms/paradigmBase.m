...
% paradigmBase defines all paradigms for multithreshold
%  other paradigm files are variations on this set of base values
% paradigmBase is applied first and then a second paradigm file supplies
...
stimulusParameters.stimulusDelayVariability=0;
