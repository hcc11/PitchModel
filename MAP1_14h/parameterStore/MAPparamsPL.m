function paramChanges=MAPparamsPL ...
...
%                        =2 prints out the complete set of parameters
%     default 0.
...
% (use default channels and print out all parameters)
...
% (use default channels and list of changes plus print out the parameters)
%   MAPparamsNormal(-1, 48000, 1, paramChanges);
% (use default channels and list of parameters changes only)
...
switch IHC_cilia_RPParams.IHCmodel
    case 'Shamma'
        ...
        IHC_cilia_RPParams.u0=	[0.3 1]*1e-9;
        IHC_cilia_RPParams.s0=	[6   1]*1e-9;
...
switch MacGregorMultiType
    case 'primary-like'
        MacGregorMultiParams.nNeuronsPerBF=	100;   % N neurons per BF
        MacGregorMultiParams.type = 'primary-like cell';
        MacGregorMultiParams.fibersPerNeuron=3;   % N input fibers
