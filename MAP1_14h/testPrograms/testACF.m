...
%
% Convert this to a *function* by uncommenting the next line
% function [P dt lags SACF]= testACF
%  The function returns the P matrix seen in Figure 96 at the end.
%  If a function is used, the following outputs are returned:
%   P:  smoothed SACF (lags x time matrix)
%   dt: time interval between successive columns of matrix P
...
minPitch=	50; maxPitch=	1000; numPitches=40;
...
if exist('fileName','var')
    % needed for labeling plot. not available for tone stimuli
...
wavplay(inputSignal, sampleRate,'async')
...
% read ACF paramChanges to get new filteredSACFParams
