function PSTH=UTIL_PSTHmaker(inputData, dt, PSTHbinWidth)
% UTIL_PSTHmaker accumulates adjacent values into bins.
% No corrections are applied
%
% This is the same routine as UTIL_makePSTH
% arguments
%	inputData is a channel x time matrix
%   dt is the sampling interval of the input signal (not clear why this is
%   returned?!)
%   PSTHbinWidth is given in seconds
%
